...
import { _ as _baseGetTag, d as _root, i as isObjectLike_1, b as isArray_1, a as isTypedArray_1, c as _overArg, e as isLength_1, f as _Symbol, D as Dnd } from './_overArg-0675a45b.js';
import { a as createCommonjsModule } from './_commonjsHelpers-a4f66ccd.js';
import { C as Container } from './index-1637bf51.js';
import { s as state } from './descriptors-store-02a4f91c.js';
import { y as ActivityDriverRegistry, A as ActivityDescriptorManager } from './index-7d63808a.js';
...
const ToolboxActivities = class {
  constructor(hostRef) {
    ...
    this.buildModel = (searchVal = '') => {
      let browsableDescriptors = uniqBy_1(state.activityDescriptors
  ...
  render() {
    return h("nav", { class: "tw-flex-1 tw-px-2 tw-space-y-1 tw-font-sans tw-text-sm tw-text-gray-600" }, h("input", { class: "tw-my-1", placeholder: "Search Activities", type: "text", name: "activity-search", id: "activitySearch", onInput: this.filterActivities.bind(this) }), this.categoryModels.map(categoryModel => {
      const category = categoryModel.category;
...
export { ToolboxActivities as elsa_workflow_definition_editor_toolbox_activities };

//# sourceMappingURL=elsa-workflow-definition-editor-toolbox-activities.entry.js.map