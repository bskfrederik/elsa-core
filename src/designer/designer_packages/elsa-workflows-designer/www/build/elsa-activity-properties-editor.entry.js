...
import { Y as ActivityKind, ag as v4, q as isNullOrWhitespace, F as InputDriverRegistry, D as EventBus, ah as ActivityPropertyPanelEvents } from './index-7d63808a.js';
...
const ActivityPropertiesEditor = class {
  constructor(hostRef) {
    ...
    this.renderCommonTab = () => {
      ...
      return h("div", { key: key }, h(FormEntry, { fieldId: "ActivityId", label: "ID", hint: "The ID of the activity." }, h("input", { type: "text", name: "ActivityId", id: "ActivityId", value: activityId, onChange: e => this.onActivityIdChanged(e) })), h(FormEntry, { fieldId: "ActivityDisplayText", label: "Display Text", hint: "The text to display on the activity in the designer." }, h("input", { type: "text", name: "ActivityDisplayText", id: "ActivityDisplayText", value: displayText, onChange: e => this.onActivityDisplayTextChanged(e) })), h(CheckboxFormEntry, { fieldId: "CanStartWorkflow", label: "Can start workflow", hint: "When enabled, this activity can be used as a trigger to automatically start the workflow." }, h("input", { type: "checkbox", name: "CanStartWorkflow", id: "CanStartWorkflow", value: "true", checked: canStartWorkflow, onChange: e => this.onCanStartWorkflowChanged(e) })));
    };
    this.renderInputTab = () => {
    ...
    this.renderTaskTab = () => {
      ...
      return h("div", { key: key }, h(CheckboxFormEntry, { fieldId: "RunAsynchronously", label: "Execute asynchronously", hint: "When enabled, this activity will execute asynchronously and suspend workflow execution until the activity is finished." }, h("input", { type: "checkbox", name: "RunAsynchronously", id: "RunAsynchronously", value: "true", checked: runAsynchronously, onChange: e => this.onRunAsynchronouslyChanged(e) })));
    };
...
export { ActivityPropertiesEditor as elsa_activity_properties_editor };

//# sourceMappingURL=elsa-activity-properties-editor.entry.js.map