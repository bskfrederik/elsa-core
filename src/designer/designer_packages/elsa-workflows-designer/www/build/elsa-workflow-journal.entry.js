...
import { q as isNullOrWhitespace, t as durationToString, af as ActivityIconSize, h as formatTime, i as getDuration, z as ActivityIconRegistry, a7 as WorkflowInstancesApi, M as walkActivities, N as flatten } from './index-7d63808a.js';
...
const Journal = class {
  ...
  render() {
    return (h("div", { class: "tw-absolute tw-inset-0 tw-overflow-hidden" }, h("div", { class: "tw-h-full tw-flex tw-flex-col tw-bg-white tw-shadow-xl" }, h("div", { class: "tw-flex tw-flex-col tw-flex-1" }, h("div", { class: "tw-px-4 tw-py-6 tw-bg-gray-50 sm:tw-px-6" }, h("div", { class: "tw-flex tw-items-start tw-justify-between tw-space-x-3" }, h("div", { class: "tw-space-y-1" }, h("h2", { class: "tw-text-lg tw-font-medium tw-text-gray-900" }, "Workflow Journal")))), h("div", { class: "tw-flex-1 tw-relative" }, h("div", { class: "tw-absolute tw-inset-0 tw-overflow-y-scroll" }, h("table", { class: "workflow-journal-table" }, h("thead", null, h("tr", null, h("th", { class: "tw-w-1" }), h("th", null, "Time"), h("th", { class: "tw-min-w-full" }, "Activity"), h("th", null, "Status"), h("th", null, "Duration"))), h("tbody", { class: "tw-bg-white tw-divide-y tw-divide-gray-100" }, this.renderBlocks(this.rootBlocks)))))))));
  }
...
export { Journal as elsa_workflow_journal };

//# sourceMappingURL=elsa-workflow-journal.entry.js.map