...
export class Tooltip {
  ...
  static get is() { return "elsa-tooltip"; }
  ...
  static get properties() {
    return {
      ...
      "tooltipPosition": {
        ...
        "mutable": false,
        "complexType": {
          "original": "'right' | 'left' | 'top' | 'bottom' | 'auto'",
        ...
        "docs": {
          "tags": [],
          "text": "Specifying `auto` will default to `bottom`, but will reposition to `top` if the tooltip height runs offscreen"
        },
