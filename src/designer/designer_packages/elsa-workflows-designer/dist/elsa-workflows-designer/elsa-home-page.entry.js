import { r as registerInstance, h, i as getAssetPath } from './index-dc0ae4f5.js';
import './Reflect-563aa1b4.js';
import { a as state, s as state$1 } from './toolbar-component-store-1febdbe0.js';
import { D as DropdownButtonOrigin } from './models-81e2e763.js';
import './_commonjsHelpers-a4f66ccd.js';
import './index-4ac684d0.js';

const homePageCss = ".default-background{background:#f3f3f3}.main-title-color{color:#2B6CB0}.sub-title-color{color:#2A4365}.tagline-color{color:#2D3748}";
...
const HomePage = class {
  ...
  async componentWillLoad() {
    var _a;
    const mainItem = (_a = state.mainItem) !== null && _a !== void 0 ? _a : {
      text: 'New'
    };
    state$1.components = [() => h("elsa-dropdown-button", { items: state.items, text: mainItem.text, handler: mainItem.handler, origin: DropdownButtonOrigin.TopRight })];
  }
  render() {
