import { S as Service, C as Container, M as ModalDialogService } from './index-1637bf51.js';
import './Reflect-563aa1b4.js';
import { s as state$6 } from './descriptors-store-02a4f91c.js';
import { c as createStore } from './index-4ac684d0.js';
import { h } from './index-dc0ae4f5.js';
import { a as createCommonjsModule, c as commonjsGlobal, g as getDefaultExportFromCjs, b as getAugmentedNamespace } from './_commonjsHelpers-a4f66ccd.js';
import { l as lodash$2 } from './lodash-cadbac1e.js';
import { N as NotificationService, a as NotificationDisplayType, h as hooks } from './notification-service-ffb5a824.js';
import { s as state$7, a as state$8 } from './toolbar-component-store-1febdbe0.js';
...
let ServerSettings = class ServerSettings {
  get baseAddress() {
    return state$5.serverAddress;
  }
  set baseAddress(value) {
    state$5.serverAddress = value;
  }
};
ServerSettings = __decorate$E([
  Service()
], ServerSettings);
...
ElsaClientProvider = __decorate$C([
  Service(),
...
let ActivityDescriptorManager = class ActivityDescriptorManager {
  ...
  async refresh() {
    ...
    state$6.activityDescriptors = await elsaClient.descriptors.activities.list();
    if (this.activityDescriptorsUpdatedCallback) {
      this.activityDescriptorsUpdatedCallback();
    }
  }
};
ActivityDescriptorManager = __decorate$B([
  Service(),
...
DefaultActivityDriver = __decorate$A([
  Service()
...
ActivityDriverRegistry = __decorate$z([
  Service()
...
ActivityIconRegistry = __decorate$y([
  Service(),
...
let AuthContext = class AuthContext {
  constructor(eventBus) {
    ...
    if (data && data.length > 0) {
      ...
      state$4.name = authData.name;
      state$4.permissions = authData.permissions;
      state$4.signedIn = authData.signedIn;
      state$4.accessToken = authData.accessToken;
      state$4.refreshToken = authData.refreshToken;
    }
  }
  ...
  updateSession(name, permissions, accessToken, refreshToken, createPersistentCookie) {
    state$4.name = name;
    state$4.permissions = permissions;
    state$4.signedIn = true;
    state$4.accessToken = accessToken;
    state$4.refreshToken = refreshToken;
    const data = JSON.stringify(state$4);
  ...
  async signOut() {
    state$4.name = null;
    state$4.permissions = [];
    state$4.signedIn = false;
    state$4.accessToken = null;
    state$4.refreshToken = null;
    sessionStorage.clear();
    js_cookie.remove('dashboard-session');
    await this.eventBus.emit(EventTypes.Auth.SignedOut);
  }
  getIsSignedIn() {
    return state$4.signedIn;
  }
  getAccessToken() {
    return state$4.accessToken;
  }
  getRefreshToken() {
    return state$4.refreshToken;
  }
};
AuthContext = __decorate$x([
  Service(),
...
InputControlRegistry = __decorate$w([
  Service(),
...
InputDriverRegistry = __decorate$v([
  Service()
], InputDriverRegistry);
...
let StudioService = class StudioService {
  show(componentFactory) {
    state$3.activeComponentFactory = componentFactory;
  }
};
StudioService = __decorate$u([
  Service()
], StudioService);
...
ActivityNameFormatter = ActivityNameFormatter_1 = __decorate$t([
  Service()
...
SequencePlugin = SequencePlugin_1 = __decorate$s([
  Service(),
...
function updatePortsAndEdgeOfNodeCouple(graph, sourceNode, targetNode, portPositionOfSourceNode, portPositionOfTargetNode) {
  ...
  if (edge != null) {
    ...
    if (!state$1.enableFlexiblePorts && isNewCalculationNeededForInflexiblePort(graph, sourceNode, sourcePortOfConnection)) {
...
lodash$1.assign = object$2.assign;
lodash$1.assignIn = object$2.assignIn;
lodash$1.assignInWith = object$2.assignInWith;
lodash$1.assignWith = object$2.assignWith;
lodash$1.at = object$2.at;
...
lodash$1.create = object$2.create;
lodash$1.curry = func.curry;
lodash$1.curryRight = func.curryRight;
lodash$1.debounce = func.debounce;
lodash$1.defaults = object$2.defaults;
lodash$1.defaultsDeep = object$2.defaultsDeep;
...
lodash$1.functions = object$2.functions;
lodash$1.functionsIn = object$2.functionsIn;
...
lodash$1.invert = object$2.invert;
lodash$1.invertBy = object$2.invertBy;
lodash$1.invokeMap = collection.invokeMap;
lodash$1.iteratee = util.iteratee;
lodash$1.keyBy = collection.keyBy;
lodash$1.keys = keys;
lodash$1.keysIn = object$2.keysIn;
lodash$1.map = collection.map;
lodash$1.mapKeys = object$2.mapKeys;
lodash$1.mapValues = object$2.mapValues;
lodash$1.matches = util.matches;
lodash$1.matchesProperty = util.matchesProperty;
lodash$1.memoize = func.memoize;
lodash$1.merge = object$2.merge;
lodash$1.mergeWith = object$2.mergeWith;
...
lodash$1.omit = object$2.omit;
lodash$1.omitBy = object$2.omitBy;
...
lodash$1.pick = object$2.pick;
lodash$1.pickBy = object$2.pickBy;
...
lodash$1.set = object$2.set;
lodash$1.setWith = object$2.setWith;
...
lodash$1.toPairs = object$2.toPairs;
lodash$1.toPairsIn = object$2.toPairsIn;
lodash$1.toPath = util.toPath;
lodash$1.toPlainObject = lang.toPlainObject;
lodash$1.transform = object$2.transform;
...
lodash$1.unset = object$2.unset;
lodash$1.unzip = array.unzip;
lodash$1.unzipWith = array.unzipWith;
lodash$1.update = object$2.update;
lodash$1.updateWith = object$2.updateWith;
lodash$1.values = object$2.values;
lodash$1.valuesIn = object$2.valuesIn;
...
// Add aliases.
lodash$1.entries = object$2.toPairs;
lodash$1.entriesIn = object$2.toPairsIn;
lodash$1.extend = object$2.assignIn;
lodash$1.extendWith = object$2.assignInWith;
...
lodash$1.findKey = object$2.findKey;
lodash$1.findLast = collection.findLast;
lodash$1.findLastIndex = array.findLastIndex;
lodash$1.findLastKey = object$2.findLastKey;
lodash$1.floor = math.floor;
lodash$1.forEach = collection.forEach;
lodash$1.forEachRight = collection.forEachRight;
lodash$1.forIn = object$2.forIn;
lodash$1.forInRight = object$2.forInRight;
lodash$1.forOwn = object$2.forOwn;
lodash$1.forOwnRight = object$2.forOwnRight;
lodash$1.get = object$2.get;
lodash$1.gt = lang.gt;
lodash$1.gte = lang.gte;
lodash$1.has = object$2.has;
lodash$1.hasIn = object$2.hasIn;
...
lodash$1.invoke = object$2.invoke;
...
lodash$1.result = object$2.result;
...
const mixins$1 = /*@__PURE__*/getDefaultExportFromCjs(mixins);
...
const inherit = /*@__PURE__*/getDefaultExportFromCjs(inherit_1);
...
let WorkflowDefinitionsApi = class WorkflowDefinitionsApi {
  ...
  async publish(request) {
    const httpClient = await this.getHttpClient();
    const response = await httpClient.post(`workflow-definitions/${request.definitionId}/publish`);
    return response.data;
  }
...
WorkflowDefinitionsApi = __decorate$r([
  Service(),
...
WorkflowDefinitionManager = __decorate$q([
  Service(),
...
class WorkflowDefinitionEditorInstance {
  constructor(workflowDefinition) {
    ...
    state$7.components = [() => h("elsa-workflow-publish-button", { onPublishClicked: this.onPublishClicked, onUnPublishClicked: this.onUnPublishClicked, onExportClicked: this.onExportClicked, onImportClicked: this.onImportClicked, disabled: workflowDefinition.isReadonly })];
    state$3.activeComponentFactory = () => h("elsa-workflow-definition-editor", { workflowDefinition: workflowDefinition, onWorkflowUpdated: this.onWorkflowUpdated, ref: el => this.workflowDefinitionEditorElement = el });
  }
}
...
class WorkflowInstanceViewerInstance {
  constructor(workflowDefinition, workflowInstance) {
    ...
    state$3.activeComponentFactory = () => h("elsa-workflow-instance-viewer", { workflowDefinition: workflowDefinition, workflowInstance: workflowInstance, ref: el => this.workflowInstanceViewerElement = el });
  }
}
...
let WorkflowDefinitionsPlugin = class WorkflowDefinitionsPlugin {
  constructor() {
    ...
    this.getActivityDescriptor = (typeName) => state$6.activityDescriptors.find(x => x.typeName == typeName);
    ...
    state$8.items = [...state$8.items, ...newMenuItems];
    state$2.items = [...state$2.items, ...toolbarItems];
  }
  async initialize() {
...
let WorkflowInstancesPlugin = class WorkflowInstancesPlugin {
  constructor() {
    ...
    state$2.items = [...state$2.items, workflowInstanceBrowserItem];
  }
  async initialize() {
  }
};
...
let WorkflowContextsPlugin = class WorkflowContextsPlugin {
  constructor() {
    ...
    this.onSignedIn = async () => {
      ...
      const installedFeatures = state$6.installedFeatures;
...
let DescriptorsPlugin = class DescriptorsPlugin {
  constructor(eventBus, elsaClientProvider, authContext) {
    ...
    this.loadDescriptors = async () => {
      ...
      state$6.activityDescriptors = activityDescriptors;
      state$6.storageDrivers = storageDrivers;
      state$6.variableDescriptors = variableDescriptors;
      state$6.workflowActivationStrategyDescriptors = workflowInstantiationStrategyDescriptors;
      state$6.installedFeatures = installedFeatures;
...
function walkActivities(root) {
  const descriptors = state$6.activityDescriptors;
...
export { EventTypes as $, ActivityDescriptorManager as A, AuthEventTypes as B, AuthContext as C, EventBus as D, ElsaClient as E, InputDriverRegistry as F, StudioService as G, ActivityNameFormatter as H, InputControlRegistry as I, ActivityNodeClass as J, createActivityLookup as K, createActivityNodeMap as L, walkActivities as M, flatten as N, flattenList as O, PluginRegistry as P, DefaultPortProvider as Q, PortProviderRegistry as R, ServerSettings as S, MonacoEditorSettings as T, WorkflowSubStatus as U, OrderBy as V, WorkflowStatus as W, OrderDirection as X, ActivityKind as Y, PortType as Z, SyntaxNames as _, ElsaClientProvider as a, EditorHeight as a0, LoginApi as a1, WorkflowDefinitionsPlugin as a2, WorkflowDefinitionsApi as a3, WorkflowDefinitionsOrderBy as a4, WorkflowDefinitionEditorService as a5, WorkflowDefinitionManager as a6, WorkflowInstancesApi as a7, WorkflowInstanceViewerInstance as a8, WorkflowInstanceViewerService as a9, uniqueId as aA, defer as aB, cloneDeep as aC, sortedIndex as aD, merge as aE, uniq as aF, difference as aG, sortedIndexBy as aH, union as aI, defaults as aJ, isEqual as aK, uuid as aL, isEmpty as aM, has as aN, template as aO, clone as aP, groupBy as aQ, max as aR, sortBy as aS, debounce as aT, isNumber as aU, pick as aV, state$2 as aW, FlowchartIcon as aX, state as aY, state$1 as aa, state$3 as ab, object as ac, removeGuidsFromPortNames as ad, WorkflowEditorEventTypes as ae, ActivityIconSize as af, v4 as ag, ActivityPropertyPanelEvents as ah, WorkflowPropertiesEditorEventTypes as ai, generateUniqueActivityName as aj, deriveNewPortId as ak, createEdge as al, autoOrientConnections as am, rebuildGraph as an, getPortNameByPortId as ao, adjustPortMarkupByNode as ap, startCase as aq, camelCase as ar, upperCase as as, lowerCase as at, upperFirst as au, isObject as av, lowerFirst as aw, isPlainObject as ax, clamp as ay, defaultsDeep as az, downloadFromBytes as b, downloadFromText as c, downloadFromUrl as d, downloadFromBlob as e, formatTimestamp as f, getSelectListItems as g, formatTime as h, getDuration as i, getObjectOrParseJson as j, getVersionOptionsString as k, getInputPropertyName as l, mapSyntaxToLanguage as m, getInputPropertyValue as n, getPropertyValue as o, parseJson as p, isNullOrWhitespace as q, serializeQueryString as r, stripActivityNameSpace as s, durationToString as t, htmlToElement as u, generateIdentity as v, formatTextWithLineBreaks as w, copyTextToClipboard as x, ActivityDriverRegistry as y, ActivityIconRegistry as z };

//# sourceMappingURL=index-7d63808a.js.map