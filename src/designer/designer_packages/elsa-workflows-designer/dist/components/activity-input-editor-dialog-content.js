...
const ActivityInputEditorDialogContent = /*@__PURE__*/ proxyCustomElement(class ActivityInputEditorDialogContent extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "elsa-activity-input-editor-dialog-content", {
    "input": [16],
    "getInput": [64]
  }]);
function defineCustomElement() {
  ...
  const components = ["elsa-activity-input-editor-dialog-content"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-activity-input-editor-dialog-content":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ActivityInputEditorDialogContent);
      }
      break;
  } });
}

export { ActivityInputEditorDialogContent as A, defineCustomElement as d };
