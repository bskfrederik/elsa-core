...
import { C as Container, z as AuthContext, V as LoginApi } from './utils.js';
import './toolbar-component-store.js';
import './descriptors-store.js';

const LoginPage = /*@__PURE__*/ proxyCustomElement(class LoginPage extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["elsa-login-page"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-login-page":
...
const ElsaLoginPage = LoginPage;
const defineCustomElement = defineCustomElement$1;

export { ElsaLoginPage, defineCustomElement };

//# sourceMappingURL=elsa-login-page.js.map