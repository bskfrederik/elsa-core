...
import { e as enter, l as leave, t as toggle } from './index3.js';
import { l as lodash } from './lodash.js';
import { T as TickIcon } from './tick.js';

var ContextMenuAnchorPoint;
(function (ContextMenuAnchorPoint) {
  ContextMenuAnchorPoint[ContextMenuAnchorPoint["TopLeft"] = 0] = "TopLeft";
  ContextMenuAnchorPoint[ContextMenuAnchorPoint["TopRight"] = 1] = "TopRight";
  ContextMenuAnchorPoint[ContextMenuAnchorPoint["BottomLeft"] = 2] = "BottomLeft";
  ContextMenuAnchorPoint[ContextMenuAnchorPoint["BottomRight"] = 3] = "BottomRight";
})(ContextMenuAnchorPoint || (ContextMenuAnchorPoint = {}));

const ContextMenu = /*@__PURE__*/ proxyCustomElement(class ContextMenu extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  get element() { return this; }
    ...
    "menuItems": [1040],
    "hideButton": [4, "hide-button"],
    "anchorPoint": [2, "anchor-point"],
    "open": [64],
    "close": [64]
...
function defineCustomElement() {
  ...
  const components = ["elsa-context-menu"];
...
export { ContextMenu as C, ContextMenuAnchorPoint as a, defineCustomElement as d };
