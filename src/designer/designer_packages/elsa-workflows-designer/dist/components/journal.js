...
import { o as isNullOrWhitespace, r as durationToString, a3 as ActivityIconSize, g as formatTime, h as getDuration, C as Container, x as ActivityIconRegistry, a0 as WorkflowInstancesApi } from './utils.js';
import { w as walkActivities, f as flatten } from './activity-walker.js';
...
const Journal = /*@__PURE__*/ proxyCustomElement(class Journal extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return journalCss; }
}, [0, "elsa-workflow-journal", {
    "model": [16],
    "workflowExecutionLogRecords": [32],
    "blocks": [32],
    "rootBlocks": [32],
    "expandedBlocks": [32],
    "journalActivityMap": [32],
    "refresh": [64]
  }]);
function defineCustomElement() {
  ...
  const components = ["elsa-workflow-journal"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-workflow-journal":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, Journal);
      }
      break;
  } });
}

export { Journal as J, defineCustomElement as d };
