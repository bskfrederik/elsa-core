import { s as state$8, a as state$9 } from './toolbar-component-store.js';
import { h } from '@stencil/core/internal/client';
import { s as state$6 } from './descriptors-store.js';
import { c as createStore } from './index2.js';
import { a as createCommonjsModule, c as commonjsGlobal, l as lodash$2, g as getAugmentedNamespace } from './lodash.js';
import { N as NotificationService, a as NotificationDisplayType, h as hooks } from './notification-service.js';
import { D as DefaultModalActions } from './modal-type.js';
import { s as state$7 } from './state.js';
...
let ModalDialogService = class ModalDialogService {
  show(content, options) {
    ...
    let instances = state$7.instances;
    instances = [...instances, newInstance];
    state$7.instances = instances;
    return newInstance;
  }
  hide(instance) {
    let instances = state$7.instances;
...
export { WorkflowDefinitionManager as $, ActivityDescriptorManager as A, EventBus as B, Container as C, InputDriverRegistry as D, ElsaClient as E, StudioService as F, ActivityNameFormatter as G, DefaultPortProvider as H, InputControlRegistry as I, PortProviderRegistry as J, WorkflowSubStatus as K, OrderDirection as L, MonacoEditorSettings as M, ActivityKind as N, OrderBy as O, PluginRegistry as P, PortType as Q, SyntaxNames as R, ServerSettings as S, EventTypes as T, EditorHeight as U, LoginApi as V, WorkflowStatus as W, WorkflowDefinitionsPlugin as X, WorkflowDefinitionsApi as Y, WorkflowDefinitionsOrderBy as Z, WorkflowDefinitionEditorService as _, ElsaClientProvider as a, WorkflowInstancesApi as a0, WorkflowInstanceViewerInstance as a1, WorkflowInstanceViewerService as a2, ActivityIconSize as a3, v4 as a4, ActivityPropertyPanelEvents as a5, state as a6, generateUniqueActivityName as a7, deriveNewPortId as a8, autoOrientConnections as a9, has as aA, template as aB, clone as aC, groupBy as aD, max as aE, sortBy as aF, debounce as aG, isNumber as aH, pick as aI, FlowchartIcon as aJ, state$1 as aK, state$3 as aL, state$2 as aM, ModalDialogService as aN, DefaultContents as aO, object as aP, removeGuidsFromPortNames as aQ, WorkflowEditorEventTypes as aR, WorkflowPropertiesEditorEventTypes as aS, createEdge as aa, Service as ab, rebuildGraph as ac, getPortNameByPortId as ad, adjustPortMarkupByNode as ae, startCase as af, camelCase as ag, isObject as ah, upperFirst as ai, lowerFirst as aj, isPlainObject as ak, clamp as al, defaultsDeep as am, uniqueId as an, defer as ao, cloneDeep as ap, sortedIndex as aq, merge as ar, uniq as as, difference as at, sortedIndexBy as au, union as av, defaults as aw, isEqual as ax, uuid as ay, isEmpty as az, downloadFromBytes as b, downloadFromText as c, downloadFromUrl as d, downloadFromBlob as e, formatTimestamp as f, formatTime as g, getDuration as h, getObjectOrParseJson as i, getVersionOptionsString as j, getInputPropertyName as k, getInputPropertyValue as l, mapSyntaxToLanguage as m, getPropertyValue as n, isNullOrWhitespace as o, parseJson as p, serializeQueryString as q, durationToString as r, stripActivityNameSpace as s, htmlToElement as t, generateIdentity as u, formatTextWithLineBreaks as v, ActivityDriverRegistry as w, ActivityIconRegistry as x, AuthEventTypes as y, AuthContext as z };
