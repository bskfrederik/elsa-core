...
const SlideOverPanel = /*@__PURE__*/ proxyCustomElement(class SlideOverPanel extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["elsa-slide-over-panel"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-slide-over-panel":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SlideOverPanel);
      }
      break;
  } });
}

const ElsaSlideOverPanel = SlideOverPanel;
const defineCustomElement = defineCustomElement$1;

export { ElsaSlideOverPanel, defineCustomElement };

//# sourceMappingURL=elsa-slide-over-panel.js.map