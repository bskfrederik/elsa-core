...
import { C as Container, x as ActivityIconRegistry, J as PortProviderRegistry, Q as PortType, o as isNullOrWhitespace, N as ActivityKind } from './utils.js';
...
const DefaultActivityTemplate = /*@__PURE__*/ proxyCustomElement(class DefaultActivityTemplate extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "elsa-default-activity-template", {
    "activityType": [1, "activity-type"],
    "activityTypeVersion": [2, "activity-type-version"],
...
function defineCustomElement$1() {
  ...
  const components = ["elsa-default-activity-template", "context-consumer"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-default-activity-template":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DefaultActivityTemplate);
      }
      break;
...
const ElsaDefaultActivityTemplate = DefaultActivityTemplate;
const defineCustomElement = defineCustomElement$1;

export { ElsaDefaultActivityTemplate, defineCustomElement };

//# sourceMappingURL=elsa-default-activity-template.js.map