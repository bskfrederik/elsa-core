...
const FlowSwitchEditor = /*@__PURE__*/ proxyCustomElement(class FlowSwitchEditor extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement$1() {
  ...
  const components = ["elsa-flow-switch-editor", "elsa-monaco-editor"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-flow-switch-editor":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, FlowSwitchEditor);
      }
      break;
...
const ElsaFlowSwitchEditor = FlowSwitchEditor;
const defineCustomElement = defineCustomElement$1;

export { ElsaFlowSwitchEditor, defineCustomElement };

//# sourceMappingURL=elsa-flow-switch-editor.js.map