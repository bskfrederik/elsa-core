...
const ElsaPager = /*@__PURE__*/ proxyCustomElement(class ElsaPager extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["elsa-pager"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-pager":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ElsaPager);
      }
      break;
  } });
}

export { ElsaPager as E, defineCustomElement as d };
