...
import { _ as _baseIsTypedArray, a as _nodeUtil, b as _baseGetTag, c as _root, i as isObjectLike_1, d as isLength_1, e as _Symbol, D as Dnd } from './_nodeUtil.js';
import { a as createCommonjsModule } from './lodash.js';
import { s as state } from './descriptors-store.js';
import { C as Container, w as ActivityDriverRegistry, A as ActivityDescriptorManager } from './utils.js';
...
const ToolboxActivities = /*@__PURE__*/ proxyCustomElement(class ToolboxActivities extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.buildModel = (searchVal = '') => {
      let browsableDescriptors = uniqBy_1(state.activityDescriptors.filter(x => x.isBrowsable !== false).sort((a, b) => (a.version > b.version ? 1 : -1)), x => `${x.typeName}:${x.version}`);
      if (searchVal) {
...
}, [0, "elsa-workflow-definition-editor-toolbox-activities", {
    "graph": [16],
    "isReadonly": [4, "is-readonly"],
    "expandedCategories": [32],
    "categoryModels": [32],
    "renderedActivities": [32]
  }]);
function defineCustomElement() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["elsa-workflow-definition-editor-toolbox-activities", "elsa-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-workflow-definition-editor-toolbox-activities":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ToolboxActivities);
      }
      break;
    case "elsa-tooltip":
      if (!customElements.get(tagName)) {
...
export { ToolboxActivities as T, defineCustomElement as d };
