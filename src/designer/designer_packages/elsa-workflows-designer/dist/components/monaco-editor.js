...
import { o as isNullOrWhitespace, a6 as state } from './utils.js';
...
const ElsaMonaco = /*@__PURE__*/ proxyCustomElement(class ElsaMonaco extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return monacoEditorCss; }
}, [0, "elsa-monaco-editor", {
    "editorHeight": [513, "editor-height"],
    "value": [1],
    "language": [1],
    "singleLineMode": [516, "single-line"],
    "padding": [1],
    "setValue": [64],
    "addJavaScriptLib": [64]
  }]);
function defineCustomElement() {
  ...
  const components = ["elsa-monaco-editor"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-monaco-editor":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ElsaMonaco);
      }
      break;
  } });
}

export { ElsaMonaco as E, defineCustomElement as d };
