...
import { Z as WorkflowDefinitionsOrderBy, aO as DefaultContents, C as Container, Y as WorkflowDefinitionsApi, aN as ModalDialogService, A as ActivityDescriptorManager } from './utils.js';
...
const WorkflowDefinitionBrowser = /*@__PURE__*/ proxyCustomElement(class WorkflowDefinitionBrowser extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [0, "elsa-workflow-definition-browser", {
    "customActions": [16],
    "workflowDefinitions": [32],
    "publishedWorkflowDefinitions": [32],
    "selectedWorkflowDefinitionIds": [32],
    "currentPage": [32],
    "currentPageSize": [32],
    "orderBy": [32],
    "labels": [32],
...
function defineCustomElement$1() {
  ...
  const components = ["elsa-workflow-definition-browser", "elsa-context-menu", "elsa-dropdown-button", "elsa-pager"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-workflow-definition-browser":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, WorkflowDefinitionBrowser);
      }
      break;
...
const ElsaWorkflowDefinitionBrowser = WorkflowDefinitionBrowser;
const defineCustomElement = defineCustomElement$1;

export { ElsaWorkflowDefinitionBrowser, defineCustomElement };

//# sourceMappingURL=elsa-workflow-definition-browser.js.map