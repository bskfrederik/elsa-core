...
import { T as TickIcon } from './tick.js';
...
const ConfigIcon = () => h("svg", { class: "tw-h-6 tw-w-6", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
...
const LabelPicker = /*@__PURE__*/ proxyCustomElement(class LabelPicker extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.selectedLabelsChanged = createEvent(this, "selectedLabelsChanged", 7);
    this.renderFlyout = () => {
    ...
    this.filterLabelsDebounced = lodash.debounce(this.filterLabels, 200);
    this.filteredLabels = state.labels;
  }
...
function defineCustomElement$1() {
  ...
  const components = ["elsa-label-picker"];
  components.forEach(tagName => { switch (tagName) {
    case "elsa-label-picker":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LabelPicker);
      }
      break;
  } });
}

const ElsaLabelPicker = LabelPicker;
const defineCustomElement = defineCustomElement$1;

export { ElsaLabelPicker, defineCustomElement };

//# sourceMappingURL=elsa-label-picker.js.map