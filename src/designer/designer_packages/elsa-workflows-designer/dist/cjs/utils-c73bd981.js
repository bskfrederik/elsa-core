...
exports.EventBus = __decorate$G([
  Service()
], exports.EventBus);

const { state: state$6, onChange: onChange$6 } = index.createStore({
  serverAddress: '',
});
...
exports.ServerSettings = class ServerSettings {
  get baseAddress() {
...
exports.ServerSettings = __decorate$F([
  Service()
...
exports.WorkflowSubStatus = void 0;
...
})(exports.WorkflowSubStatus || (exports.WorkflowSubStatus = {}));
...
})(exports.SyntaxNames || (exports.SyntaxNames = {}));
...
exports.EditorHeight = void 0;
(function (EditorHeight) {
  EditorHeight["Default"] = "Default";
  EditorHeight["Large"] = "Large";
})(exports.EditorHeight || (exports.EditorHeight = {}));
...
exports.ElsaClientProvider = class ElsaClientProvider {
...
exports.ElsaClientProvider = __decorate$D([
  Service(),
  __metadata$m("design:paramtypes", [exports.ServerSettings])
], exports.ElsaClientProvider);
async function createHttpClient(baseAddress) {
  const config = {
    baseURL: baseAddress
  };
  const eventBus = Container.get(exports.EventBus);
...
exports.ActivityDescriptorManager = class ActivityDescriptorManager {
  constructor() {
    this.activityDescriptorsUpdatedCallback = null;
    this.elsaClientProvider = Container.get(exports.ElsaClientProvider);
  }
  ...
  async refresh() {
    ...
    descriptorsStore.state.activityDescriptors = await elsaClient.descriptors.activities.list();
    if (this.activityDescriptorsUpdatedCallback) {
      this.activityDescriptorsUpdatedCallback();
    }
  }
};
exports.ActivityDescriptorManager = __decorate$C([
  Service(),
  __metadata$l("design:paramtypes", [])
], exports.ActivityDescriptorManager);
...
exports.ActivityDriverRegistry = class ActivityDriverRegistry {
  constructor() {
...
exports.ActivityDriverRegistry = __decorate$A([
  Service()
], exports.ActivityDriverRegistry);

exports.ActivityIconSize = void 0;
...
})(exports.ActivityIconSize || (exports.ActivityIconSize = {}));
...
function sizeToClass(size) {
  switch (size) {
    case exports.ActivityIconSize.Small:
      return 'tw-h-4 tw-w-4';
    case exports.ActivityIconSize.Medium:
      return 'tw-h-6 tw-w-6';
    case exports.ActivityIconSize.Large:
...
const DefaultIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" }),
  index$1.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M15 12a3 3 0 11-6 0 3 3 0 016 0z" })));

const DelayIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M9 4.55a8 8 0 0 1 6 14.9m0 -4.45v5h5" }),
  index$1.h("path", { d: "M11 19.95a8 8 0 0 1 -5.3 -12.8", "stroke-dasharray": ".001 4.13" })));

const EventIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("polyline", { points: "13 3 13 10 19 10 11 21 11 14 5 14 13 3" })));

const FlowDecisionIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
  index$1.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" })));

const FlowJoinIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("circle", { cx: "12", cy: "18", r: "2" }),
  index$1.h("circle", { cx: "7", cy: "6", r: "2" }),
  index$1.h("circle", { cx: "17", cy: "6", r: "2" }),
  index$1.h("path", { d: "M7 8v2a2 2 0 0 0 2 2h6a2 2 0 0 0 2 -2v-2" }),
  index$1.h("line", { x1: "12", y1: "12", x2: "12", y2: "16" })));

const FlowNodeIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { d: "M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z" })));

const FlowchartIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("rect", { x: "3", y: "3", width: "6", height: "6", rx: "1" }),
  index$1.h("rect", { x: "15", y: "15", width: "6", height: "6", rx: "1" }),
  index$1.h("path", { d: "M21 11v-3a2 2 0 0 0 -2 -2h-6l3 3m0 -6l-3 3" }),
  index$1.h("path", { d: "M3 13v3a2 2 0 0 0 2 2h6l-3 -3m0 6l3 -3" })));

const ForEachIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M4 12v-3a3 3 0 0 1 3 -3h13m-3 -3l3 3l-3 3" }),
  index$1.h("path", { d: "M20 12v3a3 3 0 0 1 -3 3h-13m3 3l-3-3l3-3" }),
  index$1.h("path", { d: "M11 11l1 -1v4" })));

const HttpEndpointIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M7 18a4.6 4.4 0 0 1 0 -9h0a5 4.5 0 0 1 11 2h1a3.5 3.5 0 0 1 0 7h-12" })));

const HttpResponseIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" })));

const IfIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
  index$1.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" })));

const ReadLineIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M5 5h3m4 0h9" }),
  index$1.h("path", { d: "M3 10h11m4 0h1" }),
  index$1.h("path", { d: "M5 15h5m4 0h7" }),
  index$1.h("path", { d: "M3 20h9m4 0h3" })));

const RunJavaScriptIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M14 3v4a1 1 0 0 0 1 1h4" }),
  index$1.h("path", { d: "M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" }),
  index$1.h("path", { d: "M10 13l-1 2l1 2" }),
  index$1.h("path", { d: "M14 13l1 2l-1 2" })));

const TimerIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("circle", { cx: "12", cy: "12", r: "9" }),
  index$1.h("polyline", { points: "12 7 12 12 15 15" })));

const WriteLineIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M4 20h4l10.5 -10.5a1.5 1.5 0 0 0 -4 -4l-10.5 10.5v4" }),
  index$1.h("line", { x1: "13.5", y1: "6.5", x2: "17.5", y2: "10.5" })));

const CorrelateIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("circle", { cx: "6", cy: "6", r: "2" }),
  index$1.h("circle", { cx: "18", cy: "18", r: "2" }),
  index$1.h("path", { d: "M11 6h5a2 2 0 0 1 2 2v8" }),
  index$1.h("polyline", { points: "14 9 11 6 14 3" }),
  index$1.h("path", { d: "M13 18h-5a2 2 0 0 1 -2 -2v-8" }),
  index$1.h("polyline", { points: "10 15 13 18 10 21" })));

const ForIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M4 12v-3a3 3 0 0 1 3 -3h13m-3 -3l3 3l-3 3" }),
  index$1.h("path", { d: "M20 12v3a3 3 0 0 1 -3 3h-13m3 3l-3-3l3-3" }),
  index$1.h("path", { d: "M11 11l1 -1v4" })));

const FinishIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" })));

const FaultIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" })));

const SetNameIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  "  ",
  index$1.h("line", { x1: "11", y1: "5", x2: "17", y2: "5" }),
  "  ",
  index$1.h("line", { x1: "7", y1: "19", x2: "13", y2: "19" }),
  "  ",
  index$1.h("line", { x1: "14", y1: "5", x2: "10", y2: "19" })));

const SetVariableIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  "  ",
  index$1.h("path", { d: "M4 20h4l10.5 -10.5a1.5 1.5 0 0 0 -4 -4l-10.5 10.5v4" }),
  "  ",
...
const StartIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("circle", { cx: "12", cy: "12", r: "10" })));

const StartAtIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("rect", { x: "4", y: "5", width: "16", height: "16", rx: "2" }),
  index$1.h("line", { x1: "16", y1: "3", x2: "16", y2: "7" }),
  index$1.h("line", { x1: "8", y1: "3", x2: "8", y2: "7" }),
  index$1.h("line", { x1: "4", y1: "11", x2: "20", y2: "11" }),
  index$1.h("line", { x1: "11", y1: "15", x2: "12", y2: "15" }),
  index$1.h("line", { x1: "12", y1: "15", x2: "12", y2: "18" })));

const BreakIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M9 11l-4 4l4 4m-4 -4h11a4 4 0 0 0 0 -8h-1" })));

const ForkIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("circle", { cx: "12", cy: "18", r: "2" }),
  index$1.h("circle", { cx: "7", cy: "6", r: "2" }),
  index$1.h("circle", { cx: "17", cy: "6", r: "2" }),
...
const CompleteIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  "  ",
  index$1.h("circle", { cx: "12", cy: "12", r: "9" }),
  "  ",
  index$1.h("path", { d: "M9 12l2 2l4 -4" })));

const PublishEventIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("polyline", { points: "13 3 13 10 19 10 11 21 11 14 5 14 13 3" })));

const RunTaskIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" }),
  index$1.h("circle", { cx: "12", cy: "12", r: "3" })));

const CronIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("circle", { cx: "12", cy: "12", r: "9" }),
  index$1.h("polyline", { points: "12 7 12 12 15 15" })));
...
exports.ActivityIconRegistry = class ActivityIconRegistry {
  constructor() {
    this.iconMap = new Map();
    this.add('Elsa.WriteLine', settings => index$1.h(WriteLineIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.ReadLine', settings => index$1.h(ReadLineIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.If', settings => index$1.h(IfIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.Flowchart', settings => index$1.h(FlowchartIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.Fork', settings => index$1.h(ForkIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.HttpEndpoint', settings => index$1.h(HttpEndpointIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.WriteHttpResponse', settings => index$1.h(HttpResponseIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.ForEach', settings => index$1.h(ForEachIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.For', settings => index$1.h(ForIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.While', settings => index$1.h(ForIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.Break', settings => index$1.h(BreakIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.Delay', settings => index$1.h(DelayIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.Timer', settings => index$1.h(TimerIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.Cron', settings => index$1.h(CronIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.StartAt', settings => index$1.h(StartAtIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.FlowDecision', settings => index$1.h(FlowDecisionIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.Event', settings => index$1.h(EventIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.PublishEvent', settings => index$1.h(PublishEventIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.RunJavaScript', settings => index$1.h(RunJavaScriptIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.FlowJoin', settings => index$1.h(FlowJoinIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.FlowNode', settings => index$1.h(FlowNodeIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add("Elsa.Correlate", settings => index$1.h(CorrelateIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add("Elsa.Start", settings => index$1.h(StartIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add("Elsa.Finish", settings => index$1.h(FinishIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.Fault', settings => index$1.h(FaultIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.Complete', settings => index$1.h(CompleteIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.SetName', settings => index$1.h(SetNameIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.SetVariable', settings => index$1.h(SetVariableIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    this.add('Elsa.RunTask', settings => index$1.h(RunTaskIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
  }
  ...
  getOrDefault(activityType) {
    var _a;
    return (_a = this.iconMap.get(activityType)) !== null && _a !== void 0 ? _a : ((settings) => index$1.h(DefaultIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
  }
  has(activityType) {
    return this.iconMap.has(activityType);
  }
};
exports.ActivityIconRegistry = __decorate$z([
  Service(),
  __metadata$k("design:paramtypes", [])
], exports.ActivityIconRegistry);
...
const { state: state$5, onChange: onChange$5 } = index.createStore({
  accessToken: null,
  refreshToken: null,
  name: null,
  permissions: [],
...
exports.AuthContext = class AuthContext {
...
exports.AuthContext = __decorate$y([
  Service(),
  __metadata$j("design:paramtypes", [exports.EventBus])
], exports.AuthContext);
...
exports.InputControlRegistry = class InputControlRegistry {
  constructor() {
    this.inputMap = new Map();
    this.add('single-line', c => index$1.h("elsa-single-line-input", { inputContext: c }));
    this.add('multi-line', c => index$1.h("elsa-multi-line-input", { inputContext: c }));
    this.add('dropdown', c => index$1.h("elsa-dropdown-input", { inputContext: c }));
    this.add('check-list', c => index$1.h("elsa-check-list-input", { inputContext: c }));
    this.add('radio-list', c => index$1.h("elsa-radio-list-input", { inputContext: c }));
    this.add('multi-text', c => index$1.h("elsa-multi-text-input", { inputContext: c }));
    this.add('code-editor', c => index$1.h("elsa-code-editor-input", { inputContext: c }));
    this.add('checkbox', c => index$1.h("elsa-checkbox-input", { inputContext: c }));
    this.add('variable-picker', c => index$1.h("elsa-variable-picker-input", { inputContext: c }));
    this.add('type-picker', c => index$1.h("elsa-type-picker-input", { inputContext: c }));
    this.add('output-picker', c => index$1.h("elsa-output-picker-input", { inputContext: c }));
    this.add('outcome-picker', c => index$1.h("elsa-outcome-picker-input", { inputContext: c }));
  }
  add(uiHint, control) {
...
exports.InputControlRegistry = __decorate$x([
  Service(),
  __metadata$i("design:paramtypes", [])
], exports.InputControlRegistry);
...
class DefaultInputDriver {
  constructor() {
    this.inputControlRegistry = Container.get(exports.InputControlRegistry);
  }
  get priority() {
    return -1;
  }
...
exports.InputDriverRegistry = class InputDriverRegistry {
  constructor() {
    this.drivers = [new DefaultInputDriver()];
  }
  add(driver) {
    const drivers = [...this.drivers, driver];
    this.drivers = lodash$2.lodash.orderBy(drivers, x => x.priority, 'desc');
  }
  get(context) {
    return this.drivers.find(x => x.supportsInput(context));
  }
};
exports.InputDriverRegistry = __decorate$w([
  Service()
], exports.InputDriverRegistry);

const { state: state$4, onChange: onChange$4 } = index.createStore({
  activeComponentFactory: () => index$1.h("elsa-blank", null),
  modalComponents: []
});
...
exports.StudioService = class StudioService {
  show(componentFactory) {
    state$4.activeComponentFactory = componentFactory;
  }
};
exports.StudioService = __decorate$v([
  Service()
...
exports.ActivityNameFormatter = ActivityNameFormatter_1 = class ActivityNameFormatter {
  constructor() {
...
exports.ActivityNameFormatter.DefaultStrategy = context => `${stripActivityNameSpace(context.activityDescriptor.typeName)}${context.count}`;
exports.ActivityNameFormatter.UnderscoreStrategy = context => `${stripActivityNameSpace(context.activityDescriptor.typeName)}_${context.count}`;
exports.ActivityNameFormatter.PascalCaseStrategy = context => lodash$2.lodash.startCase(lodash$2.lodash.camelCase(ActivityNameFormatter_1.DefaultStrategy(context))).replace(/ /g, '');
exports.ActivityNameFormatter.CamelCaseStrategy = context => lodash$2.lodash.camelCase(ActivityNameFormatter_1.DefaultStrategy(context));
exports.ActivityNameFormatter.SnakeCaseStrategy = context => lodash$2.lodash.snakeCase(ActivityNameFormatter_1.DefaultStrategy(context));
exports.ActivityNameFormatter.KebabCaseStrategy = context => lodash$2.lodash.kebabCase(ActivityNameFormatter_1.DefaultStrategy(context));
exports.ActivityNameFormatter = ActivityNameFormatter_1 = __decorate$u([
  Service()
], exports.ActivityNameFormatter);
...
let SequencePlugin = SequencePlugin_1 = class SequencePlugin {
  constructor() {
    const iconRegistry = Container.get(exports.ActivityIconRegistry);
    iconRegistry.add(SequencePlugin_1.ActivityTypeName, settings => index$1.h(SequenceIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
  }
  async initialize() {
  }
};
...
const SequenceIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("path", { d: "M9 4.55a8 8 0 0 1 6 14.9m0 -4.45v5h5" }),
  index$1.h("path", { d: "M11 19.95a8 8 0 0 1 -5.3 -12.8", "stroke-dasharray": ".001 4.13" })));

const activityNameFormatter = Container.get(exports.ActivityNameFormatter);
...
const { state: state$3, onChange: onChange$3 } = index.createStore({
  items: [],
});
...
const { state: state$2, onChange: onChange$2 } = index.createStore({
...
var mixins = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var inherit_1 = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const lodash_es_1 = /*@__PURE__*/_commonjsHelpers.getAugmentedNamespace(lodash);
...
exports.WorkflowDefinitionsApi = class WorkflowDefinitionsApi {
...
exports.WorkflowDefinitionsApi = __decorate$s([
  Service(),
  __metadata$g("design:paramtypes", [exports.ElsaClientProvider])
], exports.WorkflowDefinitionsApi);
exports.WorkflowDefinitionsOrderBy = void 0;
(function (WorkflowDefinitionsOrderBy) {
  WorkflowDefinitionsOrderBy["Name"] = "Name";
  WorkflowDefinitionsOrderBy["Created"] = "Created";
})(exports.WorkflowDefinitionsOrderBy || (exports.WorkflowDefinitionsOrderBy = {}));
...
exports.WorkflowDefinitionManager = class WorkflowDefinitionManager {
  constructor() {
    ...
    this.api = Container.get(exports.WorkflowDefinitionsApi);
    this.activityDescriptorManager = Container.get(exports.ActivityDescriptorManager);
  }
};
exports.WorkflowDefinitionManager = __decorate$r([
  Service(),
  __metadata$f("design:paramtypes", [])
], exports.WorkflowDefinitionManager);
...
})(exports.ModalActionType || (exports.ModalActionType = {}));
class DefaultModalActions {
}
DefaultModalActions.Cancel = (handler) => ({
  text: 'Cancel',
  name: 'Cancel',
  type: exports.ModalActionType.Cancel,
  onClick: handler
});
...
DefaultModalActions.Save = (handler) => ({
  text: 'Save',
  name: 'Save',
  type: exports.ModalActionType.Submit,
  isPrimary: true,
  onClick: handler
});
DefaultModalActions.Delete = (handler) => ({
  text: 'Delete',
  name: 'Delete',
  type: exports.ModalActionType.Button,
  isDangerous: true,
  onClick: handler
});
...
const WarningIcon = () => index$1.h("svg", { "aria-hidden": "true", class: "tw-mx-auto tw-mb-4 tw-w-14 tw-h-14 tw-text-gray-400 dark:tw-text-gray-200", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" },
  index$1.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }));

class DefaultContents {
}
DefaultContents.Warning = (message) => {
  return (index$1.h("div", { class: "tw-p-6 tw-text-center" },
    index$1.h(WarningIcon, null),
    index$1.h("h3", { class: "tw-mb-5 tw-text-lg tw-font-normal tw-text-gray-500 dark:tw-text-gray-400" }, message)));
};
...
const { state: state$1, onChange: onChange$1 } = index.createStore({
  instances: []
});
...
exports.ModalDialogService = class ModalDialogService {
...
exports.ModalDialogService = __decorate$q([
  Service()
], exports.ModalDialogService);
...
class WorkflowDefinitionEditorInstance {
  constructor(workflowDefinition) {
    ...
    this.onPublishClicked = async (e) => {
      ...
      e.detail.begin();
      const notification = notificationService.NotificationService.createNotification({
        title: 'Publishing',
        id: uuid(),
        text: 'Workflow is being published. Please wait.',
        type: notificationService.NotificationDisplayType.InProgress
      });
      await this.saveWorkflowDefinition(definition, true)
        .then(async () => {
        var _a;
        notificationService.NotificationService.updateNotification(notification, { title: 'Workflow published', text: 'Published!' });
        e.detail.complete();
        ...
        notificationService.NotificationService.updateNotification(notification, {
          title: 'Error while publishing',
          text: index$1.h("span", null,
            "Workflow ",
            definition.definitionId,
            " could not be published."),
          type: notificationService.NotificationDisplayType.Error
        });
        e.detail.complete();
      });
    };
    this.onUnPublishClicked = async (e) => {
      ...
      await this.workflowDefinitionManager.retractWorkflow(definition)
        .then(async () => {
        notificationService.NotificationService.updateNotification(notification, { title: 'Workflow unpublished', text: 'Unpublished!' });
        await this.activityDescriptorManager.refresh();
      }).catch(() => {
        notificationService.NotificationService.updateNotification(notification, {
    ...
    this.saveWorkflowDefinition = async (definition, publish) => {
      ...
      const workflowDefinitionManager = Container.get(exports.WorkflowDefinitionManager);
      ...
      await this.api.updateWorkflowReferences({ definitionId: definition.definitionId })
        ...
        if (response.affectedWorkflows.length > 0) {
          notificationService.NotificationService.createNotification({
            ...
            id: uuid(),
            text: message,
            type: notificationService.NotificationDisplayType.Success
          });
        }
      }).catch(() => {
        notificationService.NotificationService.createNotification({
    ...
    this.api = Container.get(exports.WorkflowDefinitionsApi);
    this.activityDescriptorManager = Container.get(exports.ActivityDescriptorManager);
    this.workflowDefinitionManager = Container.get(exports.WorkflowDefinitionManager);
    this.workflowDefinitionEditorService = Container.get(exports.WorkflowDefinitionEditorService);
    toolbarComponentStore.state.components = [() => index$1.h("elsa-workflow-publish-button", { onPublishClicked: this.onPublishClicked, onUnPublishClicked: this.onUnPublishClicked, onExportClicked: this.onExportClicked, onImportClicked: this.onImportClicked, disabled: workflowDefinition.isReadonly })];
    state$4.activeComponentFactory = () => index$1.h("elsa-workflow-definition-editor", { workflowDefinition: workflowDefinition, onWorkflowUpdated: this.onWorkflowUpdated, ref: el => this.workflowDefinitionEditorElement = el });
  }
}
...
exports.WorkflowDefinitionEditorService = class WorkflowDefinitionEditorService {
  constructor() {
...
exports.WorkflowDefinitionEditorService = __decorate$p([
  Service()
], exports.WorkflowDefinitionEditorService);

class WorkflowInstanceViewerInstance {
  constructor(workflowDefinition, workflowInstance) {
    this.workflowDefinition = workflowDefinition;
    this.workflowInstance = workflowInstance;
    state$4.activeComponentFactory = () => index$1.h("elsa-workflow-instance-viewer", { workflowDefinition: workflowDefinition, workflowInstance: workflowInstance, ref: el => this.workflowInstanceViewerElement = el });
  }
}
...
exports.WorkflowInstanceViewerService = class WorkflowInstanceViewerService {
  constructor() {
...
exports.WorkflowInstanceViewerService = __decorate$o([
  Service()
], exports.WorkflowInstanceViewerService);
...
exports.WorkflowInstancesApi = class WorkflowInstancesApi {
  constructor(provider) {
    this.getHttpClient = async () => await this.provider.getHttpClient();
    this.provider = provider;
  }
...
exports.WorkflowInstancesApi = __decorate$n([
  Service(),
  __metadata$e("design:paramtypes", [exports.ElsaClientProvider])
...
exports.WorkflowDefinitionsPlugin = class WorkflowDefinitionsPlugin {
  constructor() {
    ...
    this.getActivityDescriptor = (typeName) => descriptorsStore.state.activityDescriptors.find(x => x.typeName == typeName);
    ...
    this.onBrowseWorkflowDefinitions = async () => {
      ...
      this.workflowDefinitionBrowserInstance = this.modalDialogService.show(() => index$1.h("elsa-workflow-definition-browser", { onWorkflowDefinitionSelected: this.onWorkflowDefinitionSelected, onWorkflowInstancesSelected: this.onWorkflowInstancesSelected, onNewWorkflowDefinitionSelected: this.onNewWorkflowDefinitionSelected }), { actions });
    };
    ...
    this.onWorkflowInstancesSelected = async (e) => {
      ...
      this.workflowInstanceBrowserInstance = this.modalDialogService.show(() => index$1.h("elsa-workflow-instance-browser", { workflowDefinition: workflow, onWorkflowInstanceSelected: this.onWorkflowInstanceSelected }), { actions: [DefaultModalActions.Close()], size: 'tw-max-w-screen-2xl' });
    };
    ...
    this.showWorkflowInstanceViewer = (workflowDefinition, workflowInstance) => {
      const service = Container.get(exports.WorkflowInstanceViewerService);
      service.show(workflowDefinition, workflowInstance);
    };
    this.eventBus = Container.get(exports.EventBus);
    this.api = Container.get(exports.WorkflowDefinitionsApi);
    this.workflowDefinitionManager = Container.get(exports.WorkflowDefinitionManager);
    this.workflowDefinitionEditorService = Container.get(exports.WorkflowDefinitionEditorService);
    this.modalDialogService = Container.get(exports.ModalDialogService);
    this.activityDescriptorManager = Container.get(exports.ActivityDescriptorManager);
    this.inputControlRegistry = Container.get(exports.InputControlRegistry);
    this.workflowInstancesApi = Container.get(exports.WorkflowInstancesApi);
    const newMenuItems = [{
        order: 0,
        group: 0,
    ...
    toolbarComponentStore.state$1.items = [...toolbarComponentStore.state$1.items, ...newMenuItems];
    state$3.items = [...state$3.items, ...toolbarItems];
  }
  async initialize() {
    this.inputControlRegistry.add("workflow-definition-picker", c => index$1.h("elsa-workflow-definition-picker-input", { inputContext: c }));
  }
};
exports.WorkflowDefinitionsPlugin = __decorate$m([
  Service(),
  __metadata$d("design:paramtypes", [])
], exports.WorkflowDefinitionsPlugin);
  ...
  constructor() {
    this.onPropertyPanelRendering = (context) => {
      ...
      const versionTab = {
        order: 20,
        displayText: 'Version',
        content: () => index$1.h("elsa-workflow-definition-activity-version-settings", { renderContext: context })
      };
      context.tabs.push(versionTab);
    };
    this.eventBus = Container.get(exports.EventBus);
    this.workflowDefinitionsApi = Container.get(exports.WorkflowDefinitionsApi);
...
let WorkflowInstancesPlugin = class WorkflowInstancesPlugin {
  constructor() {
    ...
    this.onBrowseWorkflowInstances = async () => {
      ...
      this.workflowInstanceBrowserInstance = this.modalDialogService.show(() => index$1.h("elsa-workflow-instance-browser", { onWorkflowInstanceSelected: this.onWorkflowInstanceSelected }), { actions: actions, size: 'tw-max-w-screen-2xl' });
    };
    this.onWorkflowInstanceSelected = async (e) => {
      const definitionId = e.detail.definitionId;
      const instanceId = e.detail.id;
...
exports.LoginApi = class LoginApi {
...
exports.LoginApi = __decorate$j([
  Service(),
  __metadata$a("design:paramtypes", [exports.ElsaClientProvider, exports.ServerSettings])
], exports.LoginApi);
...
let LoginPlugin = class LoginPlugin {
  constructor() {
    this.onHttpClientCreated = async (e) => {
      ...
      const loginApi = Container.get(exports.LoginApi);
      axios.interceptors.request.use(async (config) => {
        const authContext = Container.get(exports.AuthContext);
    ...
    this.eventBus = Container.get(exports.EventBus);
    this.studioService = Container.get(exports.StudioService);
  ...
  async initialize() {
    ...
    if (authContext.getIsSignedIn())
      return;
    this.studioService.show(() => index$1.h("elsa-login-page", null));
  }
};
...
let HomePagePlugin = class HomePagePlugin {
  constructor(studioService, authContext) {
    ...
    this.showHomePage = () => {
      this.studioService.show(() => index$1.h("elsa-home-page", null));
    };
...
HomePagePlugin = __decorate$h([
  Service(),
  __metadata$8("design:paramtypes", [exports.StudioService, exports.AuthContext])
], HomePagePlugin);
...
let FlowchartPortProvider = class FlowchartPortProvider {
  ...
  resolvePort(portName, context) {
    const propName = lodash$2.lodash.camelCase(portName);
    const activity = context.activity;
    if (!activity)
      return null;
...
let FlowchartPlugin = class FlowchartPlugin {
  async initialize() {
    const registry = Container.get(exports.PortProviderRegistry);
...
let SwitchPortProvider = class SwitchPortProvider {
  getOutboundPorts(context) {
    ...
    const ports = cases.map(x => ({ name: x.label, displayName: x.label, type: exports.PortType.Embedded }));
    const defaultPort = { name: 'default', displayName: 'Default', type: exports.PortType.Embedded };
...
let SwitchPlugin = SwitchPlugin_1 = class SwitchPlugin {
  constructor() {
    ...
    const inputControlRegistry = Container.get(exports.InputControlRegistry);
    const portProviderRegistry = Container.get(exports.PortProviderRegistry);
    const iconRegistry = Container.get(exports.ActivityIconRegistry);
    inputControlRegistry.add('switch-editor', c => index$1.h("elsa-switch-editor", { inputContext: c }));
    portProviderRegistry.add(activityTypeName, () => Container.get(SwitchPortProvider));
    iconRegistry.add(SwitchPlugin_1.ActivityTypeName, settings => index$1.h(SwitchIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
  }
  async initialize() {
  }
};
...
const SwitchIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("polyline", { points: "15 4 19 4 19 8" }),
  index$1.h("line", { x1: "14.75", y1: "9.25", x2: "19", y2: "4" }),
  index$1.h("line", { x1: "5", y1: "19", x2: "9", y2: "15" }),
  index$1.h("polyline", { points: "15 19 19 19 19 15" }),
  index$1.h("line", { x1: "5", y1: "5", x2: "19", y2: "19" })));
...
let FlowSwitchPortProvider = class FlowSwitchPortProvider {
  getOutboundPorts(context) {
    ...
    if (activity == null)
      return [];
    const cases = (_a = activity.cases) !== null && _a !== void 0 ? _a : [];
    return cases.map(x => ({ name: x.label, displayName: x.label, type: exports.PortType.Flow }));
  }
  resolvePort(portName, context) {
    return null;
  }
...
let FlowSwitchPlugin = FlowSwitchPlugin_1 = class FlowSwitchPlugin {
  constructor() {
    ...
    const portProviderRegistry = Container.get(exports.PortProviderRegistry);
    const iconRegistry = Container.get(exports.ActivityIconRegistry);
    inputControlRegistry.add('flow-switch-editor', c => index$1.h("elsa-flow-switch-editor", { inputContext: c }));
    portProviderRegistry.add(activityTypeName, () => Container.get(FlowSwitchPortProvider));
    iconRegistry.add(FlowSwitchPlugin_1.ActivityTypeName, settings => index$1.h(FlowSwitchIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
  }
  async initialize() {
  }
};
...
const FlowSwitchIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("polyline", { points: "15 4 19 4 19 8" }),
  index$1.h("line", { x1: "14.75", y1: "9.25", x2: "19", y2: "4" }),
  index$1.h("line", { x1: "5", y1: "19", x2: "9", y2: "15" }),
...
let FlowHttpRequestPortProvider = class FlowHttpRequestPortProvider {
  getOutboundPorts(context) {
    ...
    const catchAllPort = { name: 'Unmatched status code', displayName: 'Unmatched status code', type: exports.PortType.Flow };
    const outcomes = [...statusCodes.map(x => ({ name: x.toString(), displayName: x.toString(), type: exports.PortType.Flow })), catchAllPort];
    return outcomes;
  }
  resolvePort(portName, context) {
    return null;
...
const HttpRequestIcon = (settings) => (index$1.h("svg", { class: getActivityIconCssClass(settings), width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
  index$1.h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
  index$1.h("circle", { cx: "12", cy: "12", r: "9" }),
  index$1.h("line", { x1: "3.6", y1: "9", x2: "20.4", y2: "9" }),
  index$1.h("line", { x1: "3.6", y1: "15", x2: "20.4", y2: "15" }),
  index$1.h("path", { d: "M11.5 3a17 17 0 0 0 0 18" }),
  index$1.h("path", { d: "M12.5 3a17 17 0 0 1 0 18" })));
...
let FlowHttpRequestPlugin = FlowHttpRequestPlugin_1 = class FlowHttpRequestPlugin {
  constructor() {
    ...
    iconRegistry.add(FlowHttpRequestPlugin_1.ActivityTypeName, settings => index$1.h(HttpRequestIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
  }
  async initialize() {
  }
};
...
let HttpRequestPortProvider = class HttpRequestPortProvider {
  getOutboundPorts(context) {
    ...
    if (activity == null)
      return [];
    const defaultPort = { name: 'unmatchedStatusCode', displayName: 'Unmatched status code', type: exports.PortType.Embedded }; // Hide the port from the designer until the editor uI is finished.
    const statusCodes = (_a = activity.expectedStatusCodes) !== null && _a !== void 0 ? _a : [];
    const ports = statusCodes.map(x => ({ name: x.statusCode.toString(), displayName: x.statusCode.toString(), type: exports.PortType.Embedded }));
    return [...ports, defaultPort];
  }
  resolvePort(portName, context) {
    var _a;
...
let HttpRequestPlugin = HttpRequestPlugin_1 = class HttpRequestPlugin {
  constructor() {
    ...
    iconRegistry.add(HttpRequestPlugin_1.ActivityTypeName, settings => index$1.h(HttpRequestIcon, { size: settings === null || settings === void 0 ? void 0 : settings.size }));
    inputControlRegistry.add('http-status-codes', c => index$1.h("elsa-http-status-codes-editor", { inputContext: c }));
  }
  async initialize() {
  }
};
...
WorkflowContextsApi = __decorate$6([
  Service(),
  __metadata$3("design:paramtypes", [exports.ElsaClientProvider])
], WorkflowContextsApi);
...
let WorkflowContextsPlugin = class WorkflowContextsPlugin {
  constructor() {
    ...
    this.onSignedIn = async () => {
      ...
      const installedFeatures = descriptorsStore.state.installedFeatures;
    ...
    this.onPropertyPanelRendering = (context) => {
      ...
      const contextProvidersWidget = {
        ...
        content: () => index$1.h("elsa-workflow-context-provider-check-list", { descriptors: descriptors, workflowDefinition: workflowDefinition, onWorkflowDefinitionChanged: notifyWorkflowDefinitionChanged })
      };
      const workflowContextProvidersTab = {
        ...
        tab: {
          order: 20,
          displayText: 'Context',
          content: () => index$1.h("elsa-widgets", { widgets: [contextProvidersWidget] })
        }
      };
  ...
  setupCustomInputControls() {
    const inputControlRegistry = Container.get(exports.InputControlRegistry);
    const descriptors = this.providerDescriptors;
    inputControlRegistry.add('workflow-context-provider-picker', c => index$1.h("elsa-workflow-context-provider-type-picker-input", { inputContext: c, descriptors: descriptors }));
  }
  setupSignIn() {
    const eventBus = Container.get(exports.EventBus);
...
let DescriptorsPlugin = class DescriptorsPlugin {
  constructor(eventBus, elsaClientProvider, authContext) {
    ...
    this.loadDescriptors = async () => {
      ...
      descriptorsStore.state.activityDescriptors = activityDescriptors;
      descriptorsStore.state.storageDrivers = storageDrivers;
      descriptorsStore.state.variableDescriptors = variableDescriptors;
      descriptorsStore.state.workflowActivationStrategyDescriptors = workflowInstantiationStrategyDescriptors;
      descriptorsStore.state.installedFeatures = installedFeatures;
...
DescriptorsPlugin = __decorate$4([
  Service(),
  __metadata$1("design:paramtypes", [exports.EventBus, exports.ElsaClientProvider, exports.AuthContext])
], DescriptorsPlugin);
...
exports.PluginRegistry = class PluginRegistry {
  constructor() {
    ...
    add('workflow-definitions', exports.WorkflowDefinitionsPlugin);
...
exports.PluginRegistry = __decorate$3([
  Service(),
...
exports.DefaultPortProvider = class DefaultPortProvider {
  getOutboundPorts(context) {
    const { activityDescriptor } = context;
    return [...activityDescriptor.ports];
  }
...
exports.DefaultPortProvider = __decorate$2([
  Service()
], exports.DefaultPortProvider);
...
exports.PortProviderRegistry = class PortProviderRegistry {
  constructor() {
    this.map = new Map();
    this.defaultProviderFactory = () => Container.get(exports.DefaultPortProvider);
  }
...
exports.PortProviderRegistry = __decorate$1([
  Service()
], exports.PortProviderRegistry);
...
exports.MonacoEditorSettings = class MonacoEditorSettings {
  get monacoLibPath() {
...
exports.MonacoEditorSettings = __decorate([
  Service()
], exports.MonacoEditorSettings);

function formatTimestamp(timestamp, defaultText) {
  return !!timestamp ? notificationService.hooks(timestamp).format('DD-MM-YYYY HH:mm:ss') : defaultText;
}
function formatTime(timestamp, defaultText) {
  return !!timestamp ? notificationService.hooks(timestamp).format('HH:mm:ss') : defaultText;
}
function getDuration(a, b) {
  const diff = notificationService.hooks(a).diff(notificationService.hooks(b));
  return notificationService.hooks.duration(diff);
}
...
const getInputPropertyName = (inputContext) => {
  ...
  return lodash$2.lodash.camelCase(propertyName);
};
...
const serializeQueryString = (queryString) => {
  const filteredItems = lodash$2.lodash(queryString).omitBy(lodash$2.lodash.isUndefined).omitBy(lodash$2.lodash.isNull).value();
  const queryStringItems = lodash$2.lodash.map(filteredItems, (v, k) => {
    if (Array.isArray(v)) {
...
exports.ActivityPropertyPanelEvents = ActivityPropertyPanelEvents;
exports.AuthEventTypes = AuthEventTypes;
exports.Container = Container;
exports.DefaultContents = DefaultContents;
exports.DefaultModalActions = DefaultModalActions;
exports.ElsaClient = ElsaClient;
exports.EventTypes = EventTypes;
exports.FlowchartIcon = FlowchartIcon;
exports.Service = Service;
exports.WorkflowEditorEventTypes = WorkflowEditorEventTypes;
exports.WorkflowInstanceViewerInstance = WorkflowInstanceViewerInstance;
exports.WorkflowPropertiesEditorEventTypes = WorkflowPropertiesEditorEventTypes;
exports.adjustPortMarkupByNode = adjustPortMarkupByNode;
exports.autoOrientConnections = autoOrientConnections;
...
exports.defer = defer;
exports.deriveNewPortId = deriveNewPortId;
exports.difference = difference;
exports.downloadFromBlob = downloadFromBlob;
exports.downloadFromBytes = downloadFromBytes;
exports.downloadFromText = downloadFromText;
...
exports.generateUniqueActivityName = generateUniqueActivityName;
exports.getDuration = getDuration;
exports.getInputPropertyName = getInputPropertyName;
exports.getInputPropertyValue = getInputPropertyValue;
exports.getObjectOrParseJson = getObjectOrParseJson;
exports.getPortNameByPortId = getPortNameByPortId;
...
exports.removeGuidsFromPortNames = removeGuidsFromPortNames;
...
exports.state$1 = state$2;
exports.state$2 = state$4;
exports.state$3 = state$3;
exports.state$4 = state;
exports.stripActivityNameSpace = stripActivityNameSpace;
...
//# sourceMappingURL=utils-c73bd981.js.map